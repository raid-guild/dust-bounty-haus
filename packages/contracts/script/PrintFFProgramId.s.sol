...
contract PrintFFProgramId is Script {
  function run() external view {
    bytes14 namespace = "rgtmpff1"; // your deployed namespace
    bytes16 systemName = "ForceFieldMintPr"; // your deployed system name
    ResourceId programId = WorldResourceIdLib.encode({
      typeId: RESOURCE_SYSTEM,
      namespace: namespace,
      name: systemName
    });
    console.log("Program ID for ForceFieldMintProgram:");
    ...
    (uint256 groupId, bool locked)  = defaultProgramSystem.getAccessGroupId(EntityId.wrap(0x030000051b0000009afffffc6300000000000000000000000000000000000000));
