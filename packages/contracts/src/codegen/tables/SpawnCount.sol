...
library SpawnCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "rgtmpff1", name: "SpawnCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627267746d70666631000000000000537061776e436f756e74000000000000);
